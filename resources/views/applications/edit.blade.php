            ...
            {{ Form::open(['url' => ['platform/applications', 'application' => $application], "enctype" => "multipart/form-data", 'method' => 'put']) }}
                <div id="bio" class="tab-content mt-20 flex dir-row wrap jus-between selected">
                    <div class="general flex dir-row wrap jus-between fw mb-30">
                        ...
                        <div class='half mt-10'>
                            <label class='mr-20 ml-10 upper fw'>função *</label>
                ...
                <div id="pitch" class="tab-content mt-20 flex dir-row wrap jus-between">
                    ...
                    <div class='fw'>
                        ...
                        {{ Form::textarea('pitch', $application->pitch, ['placeholder' => 'Dá-lhe tudo o que tens', 'onkeyup' => 'this.setAttribute(\'value\', this.value);', 'class' => 'dark input-text fw']) }}
                    </div>
                    <div class='fw mt-10'>
                ...
                <div id="extras" class="tab-content mt-20 flex dir-row wrap jus-between">
                    ...
                    <div class='half'>
                        ...
                        {{ Form::radio('firstTime', 0, $application->firstTime ? false : true, ['class' => 'dark input-text fw']) }} Não
                    </div>
                    ...
                    <div class='fw mt-20'>
                        ...
                        {{ Form::textarea('urls', $application->urls, ['placeholder' => 'Coloca aqui outro tipo de URLs que acredites que são importantes para ajudar na selecção da tua candidatura', 'onkeyup' => 'this.setAttribute(\'value\', this.value);', 'class' => 'dark input-text fw']) }}
                    </div>
                    <div class='fw mt-20'>
                        <label class='mr-20 ml-10 upper fw'>Comentários</label>
                        {{ Form::textarea('comments', $application->comments, ['placeholder' => 'Podes utilizar este campo para dizeres um pouco de tudo, se tens algum tipo de restrição alimentar ou algo que aches relevante a organização estar a par', 'onkeyup' => 'this.setAttribute(\'value\', this.value);', 'class' => 'dark input-text fw']) }}
                    </div>
